...
namespace ComplaintPortalServices
{
    public abstract class BaseService<T> where T : BaseEntity, new()
    {
        ...
        public BaseService(ApplicationSettings applicationSettings)
        {
            _applicationSettings = applicationSettings;
            var client = new MongoClient(_applicationSettings.DatabaseSettings.Connection_String);
            _database = client.GetDatabase(_applicationSettings.DatabaseSettings.DataBase_name);
            T temp = new();
